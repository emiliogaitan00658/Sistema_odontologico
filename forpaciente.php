                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group has-feedback">
                                                            ...
                                                            <input type="text" class="form-control phone-inputmask"
                                                                   ...
                                                                   onKeyUp="this.value=this.value.toUpperCase();"
                                                                   placeholder="Ingrese Nº de Teléfono" <?php if (isset($reg[0]['tlfpaciente'])) { ?> value="<?php echo $reg[0]['tlfpaciente']; ?>" <?php } ?>
                                                                   autocomplete="off" />
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group has-feedback">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                   ...
                                                                   onKeyUp="this.value=this.value.toUpperCase();"
                                                                   placeholder="Ingrese Ocupación Laboral" <?php if (isset($reg[0]['ocupacionpaciente'])) { ?> value="<?php echo $reg[0]['ocupacionpaciente']; ?>" <?php } ?>
                                                                   autocomplete="off" />
                                                            <i class="fa fa-pencil form-control-feedback"></i>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group has-feedback">
                                                            ...
                                                            <input type="text" class="form-control" name="direcpaciente"
                                                                   id="direcpaciente"
                                                                   onKeyUp="this.value=this.value.toUpperCase();"
                                                                   placeholder="Ingrese Dirección Domiciliaria" <?php if (isset($reg[0]['direcpaciente'])) { ?> value="<?php echo $reg[0]['direcpaciente']; ?>" <?php } ?>
                                                                   autocomplete="off" />
